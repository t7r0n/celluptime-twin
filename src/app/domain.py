...
LABEL = 'Manufacturing Cell Reliability Twin'
FIXTURE = 'robot_cell_cases.jsonl'
ANALYSIS = 'robot_cell_analysis.json'
CSV_NAME = 'cell_go_no_go.csv'
DASHBOARD_TITLE = 'Reliability-Adjusted Automation Decisions'
PRIMARY_METRIC = 'reliability_score'
